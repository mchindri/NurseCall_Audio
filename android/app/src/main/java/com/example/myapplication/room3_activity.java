...
public class room3_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_back_room3 = findViewById(R.id.button_back_room2);
        ...
        Person alex = new Person("Denis  ", "21-11-1971", "Male");
        Person diana = new Person("Pop ", "30-10-2006", "Female");
        Person mihai = new Person(" Mihai", "29-07-1996", "Female");
